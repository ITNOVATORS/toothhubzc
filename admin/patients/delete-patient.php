<?php
	...
	mysqli_query($con,"delete from `treatments` where patient_id = '$id'");
	mysqli_query($con,"delete from `payments` where patient_id = '$id'");
	mysqli_query($con,"update users set patient_id = 0 where patient_id = '$id'");
